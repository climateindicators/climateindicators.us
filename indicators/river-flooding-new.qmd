---
title: "River Flooding (new workflow)"
description: "The river flooding indicator rebuilt from EPA's published page by the build-indicator skill, for comparison against the hand-built page."
...
source(here::here("R", "river-flooding-new.R"))
...
This is a duplicate of [River Flooding](river-flooding.qmd), built a different
way, so the two can be read side by side. Every word of prose below was
extracted from EPA's published indicator page by `build_indicator.R` and moved
here unedited. The other page's prose was extracted from EPA's Word documents by
a per-indicator script and edited by hand.
:::
