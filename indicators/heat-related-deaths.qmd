...
#| label: setup
#| include: false
source(here::here("R/indicators/heat-related-deaths.R"))
hrd_meta_all <- hrd_meta()
hrd_caption <- function(file) {
  m <- hrd_meta_for(file, hrd_meta_all)
...
#| echo: false
#| output: asis
hrd_caption("heat_deaths_annual.csv")
```
...
#| label: fig-1-table
#| echo: false
knitr::kable(hrd_fig_1_table(), digits = 3)
```
...
#| echo: false
#| output: asis
hrd_caption("heat_deaths_summer_cvd.csv")
```
...
#| label: fig-2-table
#| echo: false
knitr::kable(hrd_fig_2_table(), digits = 3)
```
...
#| echo: false
#| output: asis
hrd_caption("chicago_1995_heat_wave.csv")
```
...
#| echo: false
knitr::kable(utils::head(hrd_fig_example_table(), 10), digits = 1,
