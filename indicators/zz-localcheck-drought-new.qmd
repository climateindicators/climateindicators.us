---
title: "Drought (new workflow)"
subtitle: "This indicator measures drought conditions of U.S. lands."
description: "Palmer Index, SPEI, and U.S. Drought Monitor measures of how dry the United States has been since 1895."
...
source(here::here("R", "drought-new.R"))
indicator_url <- function(repo, file) file.path("C:/Users/Alyssa Korponai/Desktop/climateindicators/New folder/indicator-new-workflow/drought-new/data", file)

meta    <- read_meta(REPO)
palmer  <- read_indicator(REPO, "drought_palmer_index.csv")
spei    <- read_indicator(REPO, "drought_spei_national.csv")
change  <- read_indicator(REPO, "drought_spei_change.csv")
monitor <- read_indicator(REPO, "drought_monitor_area.csv")
```
...
#| label: fig-1-caption
#| echo: false
figure_caption(meta, "drought_palmer_index.csv")
```
...
#| label: fig-1-table
#| echo: false
knitr::kable(fig_1_table(palmer))
```
...
#| label: fig-2-caption
#| echo: false
figure_caption(meta, "drought_spei_national.csv")
```
...
#| label: fig-3-caption
#| echo: false
figure_caption(meta, "drought_spei_change.csv")
```
...
#| label: fig-3-table
#| echo: false
knitr::kable(fig_3_table(change))
```
...
#| label: fig-4-caption
#| echo: false
figure_caption(meta, "drought_monitor_area.csv")
```
...
: Categories of Drought Severity {tbl-colwidths="[10,20,70]"}
...
#| label: fig-4-table
#| echo: false
knitr::kable(fig_4_table(monitor))
```
...
- Large and consistent decreases in the SPEI have been observed throughout the western United States. Decreases have been especially prominent in southwestern states such as California, Arizona, and New Mexico. The eastern United Statesâ€”in particular the Midwest and Northeastâ€”has experienced generally wetter conditions (see Figure 3).
...
- Over the period from 2000 through 2023, roughly 10 to 70 percent of the U.S. land area experienced conditions that were at least abnormally dry at any given time (see Figure 4). The years 2002â€“2003 and 2012â€“2013 had a relatively large area with at least abnormally dry conditions, while 2009â€“2011, 2016â€“2017, and 2019 had substantially less area experiencing drought.
...
Natural variability in the Earthâ€™s climate means that drought trends may vary slightly when measured over different time periods. Using a multi-year index as shown in Figures 2 and 3 (five-year SPEI) is relevant for examining climate trends and potential connections to climate change.^5^ Periods with extreme drought conditions (e.g., 1930s) can influence the long-term trends calculated for this indicator.
...
Data for Figure 1 were obtained from the National Oceanic and Atmospheric Administrationâ€™s National Centers for Environmental Information, which maintains a large collection of climate data online at: [www.ncei.noaa.gov/access/monitoring/climate-at-a-glance](https://www.ncei.noaa.gov/access/monitoring/climate-at-a-glance).

Data for Figures 2 and 3 came from the WestWide Drought Tracker, which is a collaboration between the University of Idaho, the Western Regional Climate Center, and the Desert Research Institute. These data are available at: <https://wrcc.dri.edu/wwdt/batchdownload.php>. The measured index values are derived from Oregon State Universityâ€™s PRISM Climate Mapping Program. Figures 2 and 3 were constructed using methods described by Vicente-Serrano et al. (2010).^11^
...
2. IPCC (Intergovernmental Panel on Climate Change). (2021). *Climate change 2021â€”The physical science basis: Working Group I contribution to the Sixth Assessment Report of the Intergovernmental Panel on Climate Change* (V. Masson-Delmotte, P. Zhai, A. Pirani, S. L. Connors, C. PÃ©an, S. Berger, N. Caud, Y. Chen, L. Goldfarb, M. I. Gomis, M. Huang, K. Leitzell, E. Lonnoy, J. B. R. Matthews, T. K. Maycock, T. Waterfield, O. YelekÃ§i, R. Yu, & B. Zhou, Eds.). Cambridge University Press. <https://doi.org/10.1017/9781009157896>
3. Gamble, J. L., Balbus, J., Berger, M., Bouye, K., Campbell, V., Chief, K., Conlon, K., Crimmins, A., Flanagan, B., Gonzalez-Maddux, C., Hallisey, E., Hutchins, S., Jantarasami, L., Khoury, S., Kiefer, M., Kolling, J., Lynn, K., Manangan, A., McDonald, M., â€¦ Wolkin, A. F. (2016). Chapter 9: Populations of concern. In USGCRP (U.S. Global Change Research Program), *The impacts of climate change on human health in the United States: A scientific assessment* (pp. 247â€“286). <https://doi.org/10.7930/J0Q81B0T>
4. Heim, R. R. (2002). A review of twentieth-century drought indices used in the United States. *Bulletin of the American Meteorological Society, 83*(8), 1149â€“1166. <https://doi.org/10.1175/1520-0477-83.8.1149>
5. Abatzoglou, J. T., McEvoy, D. J., & Redmond, K. T. (2017). The West Wide Drought Tracker: Drought monitoring at fine spatial scales. *Bulletin of the American Meteorological Society, 98*(9), 1815â€“1820. <https://doi.org/10.1175/BAMS-D-16-0193.1>
...
10. Daly, C., Halbleib, M., Smith, J. I., Gibson, W. P., Doggett, M. K., Taylor, G. H., Curtis, J., & Pasteris, P. P. (2008). Physiographically sensitive mapping of climatological temperature and precipitation across the conterminous United States. *International Journal of Climatology, 28*(15), 2031â€“2064. <https://doi.org/10.1002/joc.1688>
11. Vicente-Serrano, S. M., BeguerÃ­a, S., & LÃ³pez-Moreno, J. I. (2010). A multiscalar drought index sensitive to global warming: The standardized precipitation evapotranspiration index. *Journal of Climate, 23*(7), 1696â€“1718. <https://doi.org/10.1175/2009JCLI2909.1>
