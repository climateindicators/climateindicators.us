...
meta   <- read_meta(REPO)
conus  <- read_indicator(REPO, "us_and_global_temperature_fig1.csv")
global <- read_indicator(REPO, "us_and_global_temperature_fig2.csv")
divisions <- read_indicator(REPO, "us_and_global_temperature_fig3.csv")
```
...
#| echo: false
#| output: asis
figure_caption(meta, "us_and_global_temperature_fig1.csv")
```

<div class="d-flex flex-wrap gap-2 mb-3">
<a class="btn btn-sm btn-outline-secondary" href="https://raw.githubusercontent.com/climateindicators/us-and-global-temperature/main/data/us_and_global_temperature_fig1.csv" download><i class="bi bi-filetype-csv"></i> Figure data (CSV)</a>
...
#| echo: false
#| output: asis
figure_caption(meta, "us_and_global_temperature_fig2.csv")
```

<div class="d-flex flex-wrap gap-2 mb-3">
<a class="btn btn-sm btn-outline-secondary" href="https://raw.githubusercontent.com/climateindicators/us-and-global-temperature/main/data/us_and_global_temperature_fig2.csv" download><i class="bi bi-filetype-csv"></i> Figure data (CSV)</a>
<a class="btn btn-sm btn-outline-secondary" href="https://raw.githubusercontent.com/climateindicators/us-and-global-temperature/main/data-raw/1-2%20US%20and%20Global%20Temperature%2004-21-24.xlsx" download><i class="bi bi-file-earmark-excel"></i> EPA source workbook (XLSX)</a>
</div>
...
#| echo: false
#| output: asis
figure_caption(meta, "us_and_global_temperature_fig3.csv")
```

<div class="d-flex flex-wrap gap-2 mb-3">
<a class="btn btn-sm btn-outline-secondary" href="https://raw.githubusercontent.com/climateindicators/us-and-global-temperature/main/data/us_and_global_temperature_fig3.csv" download><i class="bi bi-filetype-csv"></i> Figure data (CSV)</a>
